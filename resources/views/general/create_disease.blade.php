...
@section('content')
    ...
    <form action="{{ url('/disease/save') }}" method="POST">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">{{ ucfirst($view) }} Disease:</h3>
                <a href="{{ url('/') }}/diseases" class="pull-right btn btn-success"> <i class="fa fa-arrow-left"></i></a>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" name="disease" id="disease" class="form-control"
                                value="{{ $Disease->disease ?? '' }}" placeholder="Enter ..." required maxlength="40">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="details" id="details" class=" form-control"
                                value="{{ $Disease->details ?? '' }}" placeholder="Enter ...">
                        </div>
                    </div>
                </div>
