...
<form action="{{ url('/medicine/save') }}" method="POST">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">{{ ucfirst($view) }} Medicine:</h3>
            <a href="{{ url('/') }}/medicines" class="pull-right btn btn-success"> <i
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" name="medicine" id="medicine" class="form-control"
                            value="{{ $Medicine->medicine ?? '' }}" placeholder="Enter ..."
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="batch_no" id="batch_no" class=" form-control"
                            value="{{ $Medicine->batch_no ?? '' }}" placeholder="Enter ..." required>
                    </div>
                </div>
            </div>
            <div class="row">
